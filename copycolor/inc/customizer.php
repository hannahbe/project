...
//enables live preview in the customizer
function copycolor_customize_preview_js() {
      wp_enqueue_script( 
           'copycolor-customizer', // Give the script a unique ID
           get_stylesheet_directory_uri() . '/js/copycolor-customizer.js', // Define the path to the JS file
